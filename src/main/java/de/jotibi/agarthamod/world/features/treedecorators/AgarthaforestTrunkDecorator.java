...
public class AgarthaforestTrunkDecorator extends TrunkVineDecorator {
	public static MapCodec<AgarthaforestTrunkDecorator> CODEC = MapCodec.unit(AgarthaforestTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("agarthamod:agarthaforest_tree_trunk_decorator"), () -> DECORATOR_TYPE);
	}
