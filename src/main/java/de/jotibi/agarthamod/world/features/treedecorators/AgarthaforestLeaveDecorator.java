...
package de.jotibi.agarthamod.world.features.treedecorators;
...
public class AgarthaforestLeaveDecorator extends LeaveVineDecorator {
	public static MapCodec<AgarthaforestLeaveDecorator> CODEC = MapCodec.unit(AgarthaforestLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("agarthamod:agarthaforest_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}

	public AgarthaforestLeaveDecorator() {
		super(0.25f);
	}
